export const List = [
	{
		...
		accordion: [
			{
				heading: "How do I add or delete recipients?",
				belowHeading:
	...
	},
	{
		...
		accordion: [
			...
			{
				heading: "Is it safe to use Transfree service?",
				belowHeading:
			...
			{
				heading: "What if there are some problems about my transfer?",
				belowHeading:
	...
	},
	{
		...
		accordion: [
			...
			{
				heading: "What is my transfer limit?",
				belowHeading:
			...
			{
				heading: "Why do you reject my transfer request?",
				belowHeading:
			...
			{
				heading: "Why can't I send money to particular country?",
				belowHeading:
	...
	},
	{
		...
		accordion: [
			...
			{
				heading: "Is there any specific cut off time for transfree?",
				belowHeading: "Yes, our cut off time is 12.30 UTC+7",
			},
		],
	},
	{
		...
		accordion: [
			...
			{
				heading: "Can I have discount for my transfer?",
				belowHeading:
	...
	},
	{
		...
		accordion: [
			{
				heading: "Does Transfree operate 24/7?",
				belowHeading:
					"No. Our operational hour is Monday - Friday : 10.00 - 18.00 UTC+7",
			},
			{
				heading: "Does The Customer Service Officer standby 24/7?",
				belowHeading:
	...
	},
	{
		...
		accordion: [
			{
				heading: "How do I receive my money?",
				belowHeading:
					"First, we will send the money to your account or recipient's bank account (account to account) as listed in your transaction detail. Then, please note that if you pay after 3 hours of ordering, your order will be considered canceled and you will have to re-order.",
			},
			{
				heading: "How long does it takes?",
				belowHeading:
			...
			{
				heading: "What do you mean by other issues?",
				belowHeading:
					"What time you pay for your transfer (Our Cut-Off Time is 13:00 UTC+7), security checks, and transfer amount",
			},
			{
				heading: "Why my money arrive late?",
				belowHeading:
					"Please be aware that our cut-off time is 13:00 UTC+7 (WIB). Kindly check when you pay for your transfer - We can't process your transfer at weekend or bank holiday - Make sure you provide the documents needed by us to process your transfer before the cut-off time - Please review your transaction detail before submitting to us since we use that to process your transfer - Other factors (in this case, we will contact you directly by our official email (admin@transfree.id) or WhatsApp (+44 7490 090659). Never trust anyone contacting you outside those contacts on our behalf",
			},
		],
	},
	{
