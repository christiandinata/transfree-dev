...
import UserFillPopUp from '../../components/dashboard/users/UserFillPopUp';
...
class UserFillItem extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      key: null
        ...
        <table>
          <tbody>
            <tr className="container-item container-header">
              ...
              <th className="column gender">Phone Number</th>
          ...
          {this.props.users.map((user, key) => {
            return (
              <tr key={key} className="container-item">
                ...
                <td className="column">{user.phone}</td>
                <td className="column">
                ...
                <td className="column action">
                  <div className="btn-primary btn-small" onClick={() => {this.props.fillUserDetail(user)}}>Edit</div><br></br>
...
class UserFills extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      activePage: 1,
    ...
    this.togglePopUpDetail = this.togglePopUpDetail.bind(this);
    this.togglePopUpAction = this.togglePopUpAction.bind(this);
  ...
  togglePopUpDetail(){
    this.setState({showPopUpDetail : !this.state.showPopUpDetail});
  }

  togglePopUpAction(){
    this.setState({showPopUpAction : !this.state.showPopUpAction});
  }

  getIdDetail(user){
    this.setState({popUpUser : user});
    this.togglePopUpDetail();
  }
  ...
  render() {
    const {showPopUpDetail, showPopUpAction, popUpUser, searchQuery} = this.state;
        ...
        <div className="container-fluid">
          <div className="container-fixed">
            ...
            { this.props.inProgress ? (
              ...
              <div>
              {showPopUpDetail ? <UserDetailPopUp text="User ID Details" user={popUpUser} closePopUp={this.togglePopUpDetail} /> : ''}
              {showPopUpAction ? <UserFillPopUp text="User Detail Completion Form" user={popUpUser} closePopUp={this.togglePopUpAction} /> : ''}
                <form className="form-container">
                  {this.handlePageChange}
                  <UserFillItem users={this.props.users} fillUserDetail={this.fillUserDetail} getIdDetail={this.getIdDetail} approveUser={this.approveUser} deleteUser={this.deleteUser} totalDocs={this.props.totalDocs}/>
...
const mapStateToProps = (state) => {
  ...
  export default connect(mapStateToProps, actions)(UserFills);
