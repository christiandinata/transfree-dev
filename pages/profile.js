...
class Profile extends React.Component {
	...
	render() {
		const {
			...
			pob,
			address,
		} = this.props.users; // menampung props yang telah diterima
		return (
			<div>
				<Header />
				<Menu />
				<div className="container-fluid">
                    ...
                    <button className="mainmenubtn btn-primary">Edit</button>
						...
						<div>
							...
							<div className="field">{idType ? idType : "-"}</div>
						</div>
						<div>
						...
						<div>
							...
							<div className="field">{idName ? idName : "-"}</div>
						</div>
						<div>
							<div className="label">Gender</div>
							<div className="field">{gender ? gender : "-"}</div>
						</div>
						<div>
							<div className="label">Date of birth</div>
							<div className="field">{dob ? dob : "-"}</div>
						</div>
						<div>
							<div className="label">Place of Birth</div>
							<div className="field">{pob ? pob : "-"}</div>
						</div>
						<div>
