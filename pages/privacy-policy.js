      ...
      <BatikOverlay>
        <Container>
          ...
          <Paper style={paperShadow}>
            ...
            <p><Link href="https://www.transfree.id"><a>At www.transfree.id</a></Link> we consider the privacy of our visitors to be extremely important. 
            This privacy policy document describes in detail the types of personal information is collected and recorded 
            by <Link href="https://www.transfree.id"><a>www.transfree.id</a></Link> and how we use it.</p>
          
            <h2>Log Files</h2>

            <p>Like many other Web sites, <Link href="https://www.transfree.id"><a>www.transfree.id</a></Link> makes use of log files. These files merely logs visitors 
            ...
            <p> <Link href="https://www.transfree.id"><a> www.transfree.id</a></Link> uses cookies to store information about visitors' preferences, to record user-specific information 
            ...
            <p> Google, as a third party vendor, uses cookies to serve ads on <Link href="https://www.transfree.id"><a> www.transfree.id</a></Link>.
            Google's use of the DART cookie enables it to serve ads to our site's visitors based upon their visit to  
            <Link href="https://www.transfree.id"><a> www.transfree.id</a></Link> and other sites on the Internet. </p>     
            ...
            <Link href="https://www.transfree.id"><a> www.transfree.id</a></Link>'s privacy policy does not apply to, and we cannot control the activities of, such other advertisers
            ...
            <Link href="https://www.transfree.id"><a> www.transfree.id</a></Link> does not knowingly collect any personally identifiable information from children under the age of 13. If a 
            parent or guardian believes that <Link href="https://www.transfree.id"><a> www.transfree.id</a></Link> has in its database the personally-identifiable information of a child under 
