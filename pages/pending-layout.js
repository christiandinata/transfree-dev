                  ...
                  <div className="source-container">
                    <div className="money-input-container">
                      <div className="money-input">
                        <span style={{color:"grey",fontWeight:600}} >You send</span>
                        <NumberFormat
          ...
          //   (this.state.fromCurrency == 'eur' && this.state.toCurrency == 'hkd' ) ?
            ...
            className="reverse-img" style={{width: "4.5%",paddingBottom:"10px",marginTop:"-15px",paddingRight:"17px"}} src="../static/images/reverse.png"/>
                  ...
                  <div className="destination-container">
                    <div className="money-input-container">
                      <div className="money-input">
                        <span style={{color:"grey",fontWeight:600}}>Recipient gets</span>
                        <NumberFormat
                        style={{fontSize:"20px",fontWeight:800,marginLeft:10}}
                          id="money-to"
                          type="text"
		  ...
		  {/*<span className="received-on">24 hours</span>*/}
                ...
                <div className="row converter-cta" >
                  ...
                  <div className="row cta-primary">
                      <a href="/" className="btn-primary-2" style={{width:"80%",marginRight:"auto",marginLeft:"10%",textAlign:"center",float:"center"}}>Create Profile</a>
                      <p >I can't fill manually? <a href="#" style={{color:"#FAAF40",textDecoration:"none"}}>Upload File</a> </p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="row fiture-mobile">
          ...
          <div className="images">
           ...
           <div className="fiture-mobile-message">
              <h1 style={{fontWeight:400}}>International <span style={{fontWeight:900,color:"#000000"}}> Money</span></h1>
             
              <h1 style={{marginTop:-30}}>Transfer <span style={{fontWeight:400,color:"#000000"}}>feels like</span> local</h1>
          ...
          <div className="fiture-mobile-benefit">
              ...
              <div className="first-message">
                <h1 style={{textAlign:"center",fontSize:"15pt",marginTop:8}}>Better rate for transfer</h1>
              ...
              <div className="first-message">
                <h1 style={{textAlign:"center",fontSize:"15pt",marginTop:8}}>Quickly sent quickly arrived</h1>
                <p style={{textAlign:"center"}}>Does your family need it for an emergency? And when you use a cheaper option,it sometimes takes longer for your money to arriveDon't worry, we are here now</p>
              </div>
              </div>
              ...
              <div className="first-message">
              <h1 style={{textAlign:"center",fontSize:"15pt",marginTop:8}}>Unchargeable for Transfer</h1>
                <p style={{textAlign:"center"}}>Does your family need it for an emergency? And when you use a cheaper option,it sometimes takes longer for your money to arriveDon't worry, we are here now</p>
              </div>
              </div>
          </div>
