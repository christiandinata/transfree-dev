	...
	progressBar() {
		return (
			<ProgressContainer step={this.state.step}>
				<ProgressList>
					<ProgressItem active={this.state.step >= 1 ? true : false}>
						<div className="step-box">1</div>Amount
					</ProgressItem>
					<ProgressItem active={this.state.step >= 2 ? true : false}>
						<div className="step-line"></div>
						<div className="step-box">2</div>Recipient
					</ProgressItem>
					<ProgressItem active={this.state.step >= 3 ? true : false}>
						<div className="step-line"></div>
						<div className="step-box">3</div>Review
					</ProgressItem>
					<ProgressItem active={this.state.step >= 4 ? true : false}>
						<div className="step-line"></div>
						<div className="step-box">4</div>Pay
					</ProgressItem>
				</ProgressList>
			</ProgressContainer>
		);
